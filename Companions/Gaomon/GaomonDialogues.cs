...
namespace gaomonmod1dot4.Companions.Gaomon
{
    ...
    public class GaomonDialogues : CompanionDialogueContainer // Must be assigned on the companion base file, setting it as the value of "GetDialogueContainer" overrideable method.
    {
        ...
        public override string NormalMessages(terraguardians.Companion companion) //Normal chitchat. If you want to get player reference, use MainMod.GetLocalPlayer.
        {
        ...
        public override string MountCompanionMessage(terraguardians.Companion companion, MountCompanionContext context)
        {
            switch(context)
            {
        ...
        public override string DismountCompanionMessage(terraguardians. Companion companion, DismountCompanionContext context)
        {
            switch(context)
            {
        ...
        public override string OnToggleShareChairMessage(terraguardians.Companion companion, bool Share)
        {
        ...
        public override void ManageOtherTopicsDialogue(terraguardians.Companion companion, MessageDialogue dialogue) //Allow you to add new dialogues to the other topics dialogue. There's one for lobby dialogues too.
        {
