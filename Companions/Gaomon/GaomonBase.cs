...
namespace gaomonmod1dot4.Companions
{
    ...
    public class GaomonBase : TerraGuardianBase
    {
        ...
        public override void UpdateAttributes(terraguardians.Companion companion) //This updates whenever the companion status are reset. If you want to change their status, or give them other benefits, here is the place.
        {
