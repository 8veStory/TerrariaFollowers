...
namespace gaomonmod1dot4.Companions.Gaomon.SubAttack
{
    ...
    public class GaoRushAttack : SubAttackBase
    {
        ...
        public override void Update(terraguardians.Companion User, SubAttackData Data)
        {
        ...
        public override bool AutoUseCondition(terraguardians.Companion User, SubAttackData Data)
        {
        ...
        public override void UpdateAnimation(terraguardians.Companion User, SubAttackData Data)
        {
